...
class CORS(object):
    ...
    :param resources:
        ...
        expressions, for which the api-wide configured options are applied.

        If the argument is a string, it is expected to be a regular expression
        for which the api-wide configured options are applied.

        Default : Match all and apply api-level configuration
    ...
    def init_app(self, app, **kwargs):
        ...
        # the api's configuration, the constructor, the kwargs to init_app, and
