...
def re_fix(reg):
    """
        ...
        enable the CORS api extension to have a more user friendly api.
    """
...
def get_cors_options(appInstance, *dicts):
    ...
    the api's configuration-specified options and any dictionaries passed. The
...
def get_app_kwarg_dict(appInstance=None):
    """Returns the dictionary of CORS specific api configurations."""
