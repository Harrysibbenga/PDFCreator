...
class Client:
    ...
    def run_wsgi_app(
        ...
        """Runs the wrapped WSGI api with the given environment.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param buffered: Convert the iterator returned by the api into
...
def run_wsgi_app(
    ...
    """
    # Copy environ to ensure any mutations by the api (ProxyFix, for
